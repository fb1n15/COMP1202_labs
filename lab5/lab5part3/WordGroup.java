...
public class WordGroup {
	...
	/**
	 * Method for creating and initialising HashMap object mapping words in the stored sentence to their quantity. 
	 * @return HashMap object storing pairs of String and Integer objects containing mapping of the words in stored sentence to their quantity.
	 */
	HashMap<String,Integer> getWordCounts() {
		//Creates new HasMap object
		HashMap<String,Integer> myMap = new HashMap<String,Integer>();
		//Creates Array of String objects using getWordsArray method.
