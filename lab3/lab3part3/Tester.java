...
public class Tester {
    ...
    public static void testPart3() {
        ...
        System.out.println("======");
        System.out.println("* Creating new Door");
        
        //create new Door, set their name, create new CardLock and attach the CardLock to the Door
        Door testDoor = new Door();
        testDoor.setRoomName("Research Labs");
        CardLock testCardLock = new CardLock();
        testDoor.attachLock(testCardLock);
        
        //create two SmardCards - one for student, one for lecturer
        SmartCard cardA = new SmartCard("Anna Undergrad");
        SmartCard cardB = new SmartCard("Dr. Bob Lecturer");
        cardB.setStaff(true);
        
        //Swipe student's card and try to open the Door
        testCardLock.swipeCard(cardA);
        testDoor.openDoor();
        
        //Swipe staff's card and try to open the Door
        testCardLock.swipeCard(cardB);
        testDoor.openDoor();
